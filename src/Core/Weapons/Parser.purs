...
parseWeaponEffect coords =
  inContext ("Coords " <> show coords) do
    inContext "WeaponEffect" do
      ...
      <|> P.try (withDurExtPercentage "Phys. weapon boost" Phys.weaponboost)
      <|> P.try (withDurExtPercentage "Mag. weapon boost" Mag.weaponboost)
      <|> P.try (withDurExtPercentage "Phys. Damage Bonus" Phys.DamageBonus)
      <|> P.try (withDurExtPercentage "Mag. Damage Bonus" Mag.DamageBonus)
