...
parseWeaponEffect coords =
  inContext ("Coords " <> show coords) do
    inContext "WeaponEffect" do
      ...
      <|> P.try (withDurExtPercentage "Phys. weapon boost" PhysicalWeaponBoost)
      <|> P.try (withDurExtPercentage "Mag. weapon boost" MagicWeaponBoost)
      <|> P.try (withDurExtPercentage "Phys. Damage Bonus" PhysicalDamageBonus)
      <|> P.try (withDurExtPercentage "Mag. Damage Bonus" MagicDamageBonus)
